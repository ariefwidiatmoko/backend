    ...
    <Grid>
      <Grid.Column width={16}>
        ...
        <Segment>
          ...
          <Card.Group itemsPerRow={8} stackable>
            {followings.length > 0 && followings.map(following => <PersonCard key={following.id} user={following} />)}
          </Card.Group>
        </Segment>}
      </Grid.Column>
    </Grid>
...
export default compose(connect(mapStateToProps, null), firestoreConnect(props => query(props)))(PeopleDashboard);